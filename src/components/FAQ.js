...
export default function FAQ() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mt-10">
      <h2 className="text-[40px] font-bold text-center dark:text-blue-50 text-zinc-950">
      ...
      {faqs.map((faq, index) => (
        <div key={index} className="border-t border-gray-200">
          <button
            className="w-full text-left py-4 flex justify-between items-center font-semibold dark:text-blue-50 text-zinc-950"
